        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col justify-between p-6">
            <div className="flex items-center space-x-2 text-card-foreground">
              {categoryIcon}
              <span className="text-sm font-medium" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif" }}>{category}</span>
            </div>
            <div className="text-card-foreground">
              <h2 className="text-4xl font-bold tracking-tight" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif" }}>{title}</h2>
              <p className="mt-2 max-w-[60%] text-xs text-muted-foreground" style={{ fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif" }}>
                {description}
              </p>
            </div>
          </div>
