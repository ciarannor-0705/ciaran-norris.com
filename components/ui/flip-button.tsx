  ...
  (
    ...
    return (
      <motion.button
        ...
        whileHover="hover"
        className={cn(
          'relative inline-block cursor-pointer perspective-[1000px] focus:outline-none',
          className,
        )}
        {...props}
      >
        <motion.span
          ...
          transition={transition}
          className={cn(defaultSpanClassName, frontClassName)}
        >
          {frontText}
        </motion.span>
        <motion.span
          ...
          transition={transition}
          className={cn(defaultSpanClassName, backClassName)}
        >
          {backContent}
        </motion.span>
