...
>(({ title, subtitle, imageUrl, actionText, href, onActionClick, className }, ref) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative w-full h-full rounded-2xl bg-transparent shadow-2xl border border-black/10",
        className
      )}
    >
      <div
      ...
      >
        ...
        <div className="relative flex flex-col justify-between rounded-xl p-4 text-white">
          <div className="flex items-start justify-between">
            <div>
              <motion.h2
                style={{ transform: "translateZ(50px)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif" }}
            ...
            <motion.a
              ...
              className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20 backdrop-blur-sm ring-1 ring-inset ring-white/30 hover:bg-white/30 transition-colors"
            >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            style={{ transform: "translateZ(40px)", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Display', system-ui, sans-serif" }}
