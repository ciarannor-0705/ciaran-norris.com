...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    contentNodes: [
      ...
      <>I joined as a Growth Intern, owning outbound pipeline from cold calls to qualification. In three months I generated over 700K in demo pipeline while also helping execute inbound channels like events and webinars.</>,
